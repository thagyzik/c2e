...
const CreatePoint = () => {
    ...
    function handleSelectedLocation(e: MapPressEvent){
        setInitialPosition([e.nativeEvent.coordinate.latitude,e.nativeEvent.coordinate.longitude])
    }
    ...
    async function handleSubmit() {
        ...
        complementoSelected === "" || items.length === 0 ){
            Alert.alert(
    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            <View style={styles.container}>
                ...
                <Text style={styles.description}>Selecione os itens vinculados a este ponto.</Text>
