    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            <View style={styles.container}>
                ...
                <Text style={styles.title}>Confirme qual o código token vinculado a este ponto de coleta.</Text>

                <Text style={styles.description}>Preencha o código token, o mesmo informado durante o cadastro.</Text>

                <TextInput placeholder='Token: ' style={styles.description} onChangeText={text=>setToken(text)}/>
