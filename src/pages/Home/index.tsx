        ...
        <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
            ...
            imageStyle={{ width: 274, height: 368}}>
                ...
                <View style={styles.footer}>
                    ...
                    <RectButton style={styles.button} onPress={handleNavigateToCreatePoint}>
                    ...
                    <RectButton style={styles.button} onPress={handleNavigateToPoints}>
                        ...
                        <Text style={styles.buttonText}>Procurar Ponto</Text>

                    </RectButton>
                    <RectButton style={styles.button} onPress={() => navigation.navigate('Administrator')}>
                        <View style={styles.buttonIcon}>
                            <Icon name="log-in" color="#FFF" size={25}/>
                        </View>
